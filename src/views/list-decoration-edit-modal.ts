...
export class ListDecorationEditModal extends WeWriteModal {
	...
	onOpen(): void {
		...
		contentEl.empty();
		contentEl.addClass('wewrite-list-deco-modal');
		...
		rootLabel.style.cssText = 'font-size:11px;margin-top:8px;color:var(--text-faint)';
		...
		itemLabel.style.cssText = 'font-size:11px;margin-top:8px;color:var(--text-faint)';
		...
		this.previewEl.style.cssText = 'border:1px solid var(--background-modifier-border);border-radius:4px;padding:8px;background:#ffffff;color:#333333;min-height:60px';
