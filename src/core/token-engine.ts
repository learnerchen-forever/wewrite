...
import type { TokenVars } from './slot-types';
...
/**
 * Build a TokenVars object from resolved palette + typography values.
 * Called once per render to provide the token context for all slot resolution.
 */
